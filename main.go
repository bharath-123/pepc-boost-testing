...
func main() {
	...
	//blockDetails, err := GetBlockByBlockHash(client, "0x1968e1f7990dc04d329ad2d256f4d808614bc951bc93081ed4555081657b8662")
	//if err != nil {
	...
	//	fmt.Printf("Gas: %v\n", tx.Gas())
	//	fmt.Printf("Nonce: %v\n", tx.Nonce())
	//	receipt, err := GetTxRecipeit(client, tx.Hash().String())
	//	if err != nil {
	//		return
	//	}
